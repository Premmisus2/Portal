...
const OpenersPanel = () => (
  <div>
    ...
    <h2 style={{fontSize:'26px',fontWeight:900,color:'var(--text-primary)',margin:'8px 0 4px'}}>The Openers — Entry Matrices</h2>
    <Body>Never freestyle the opening. Assess the prospect's digital footprint before the call and use one of these four calculated entry points. <strong style={{color:'var(--text-primary)'}}>Always wait for their response when prompted.</strong></Body>
    ...
    <div className="card" style={{padding:'20px',marginBottom:'12px'}}>
      <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'14px'}}>
        ...
        <div>
          <p style={{margin:0,fontWeight:700,color:'var(--text-primary)',fontSize:'15px'}}>The "Gap / Improvement" Approach</p>
          <p style={{margin:0,color:'var(--text-muted)',fontSize:'12px'}}>They have a site, but it's weak</p>
        </div>
      </div>
    ...
    <div className="card" style={{padding:'20px',marginBottom:'12px'}}>
      <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'14px'}}>
        ...
        <div>
          <p style={{margin:0,fontWeight:700,color:'var(--text-primary)',fontSize:'15px'}}>The Meta / GSA Approach</p>
          <p style={{margin:0,color:'var(--text-muted)',fontSize:'12px'}}>They have a presence, but no ads</p>
        </div>
      </div>
    ...
    <div className="card" style={{padding:'20px',marginBottom:'12px'}}>
      <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'14px'}}>
        ...
        <div>
          <p style={{margin:0,fontWeight:700,color:'var(--text-primary)',fontSize:'15px'}}>The "0.5 Base" Approach</p>
          <p style={{margin:0,color:'var(--text-muted)',fontSize:'12px'}}>No website, or completely broken site</p>
        </div>
      </div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'8px',margin:'8px 0'}}>
        <div style={{background:'var(--accent-glow-04)',border:'1px solid var(--accent-glow-10)',borderRadius:'8px',padding:'10px 12px'}}>
          <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.12em',textTransform:'uppercase',color:'var(--accent-ink)',margin:'0 0 4px'}}>Option 1</p>
          <p style={{color:'var(--text-secondary)',fontSize:'13px',fontStyle:'italic',margin:0}}>"When would you have a moment to discuss how we can get a professional website live for you by next week?"</p>
        </div>
        <div style={{background:'var(--accent-glow-04)',border:'1px solid var(--accent-glow-10)',borderRadius:'8px',padding:'10px 12px'}}>
          <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.12em',textTransform:'uppercase',color:'var(--accent-ink)',margin:'0 0 4px'}}>Option 2</p>
          <p style={{color:'var(--text-secondary)',fontSize:'13px',fontStyle:'italic',margin:0}}>"Is there a reason why you guys don't have a website or aren't online?"</p>
        </div>
      </div>
    ...
    <div className="card-glow" style={{padding:'20px'}}>
      <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'14px'}}>
        ...
        <div>
          <p style={{margin:0,fontWeight:700,color:'var(--text-primary)',fontSize:'15px'}}>The "Pre-Built Preview" Approach</p>
          <p style={{margin:0,color:'var(--accent-ink)',fontSize:'12px',fontWeight:600}}>The Warmest Entry — Use whenever possible</p>
        </div>
      </div>
