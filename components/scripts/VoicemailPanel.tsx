...
const VoicemailPanel = () => (
  <div className="print-area" style={{maxWidth:'820px',margin:'0 auto',padding:'32px 28px'}}>
    ...
    <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'8px'}}>
      ...
      <span style={{fontSize:'11px',color:'var(--text-muted)',fontWeight:600}}>No preview site built yet</span>
    </div>
    <Rep>
    ...
    <div style={{marginTop:'6px'}}>
      <Body><strong style={{color:'var(--text-primary)'}}>Why it works:</strong> "Costing you leads" creates urgency without being salesy. The text follow-up gives them a low-friction way to engage.</Body>
    </div>
    ...
    <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'8px'}}>
      <span className="tag" style={{fontSize:'9px'}}>15-20 SEC</span>
      <span style={{fontSize:'11px',color:'var(--text-muted)',fontWeight:600}}>Preview site already built</span>
    </div>
    <Rep>
    ...
    <div style={{marginTop:'6px'}}>
      <Body><strong style={{color:'var(--text-primary)'}}>Why it works:</strong> "I built something for you" is impossible to ignore. Nobody else in the market does this. Massive curiosity — they WILL look at the link.</Body>
    </div>
    ...
    <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'8px'}}>
      ...
      <span style={{fontSize:'11px',color:'var(--text-muted)',fontWeight:600}}>Second or third attempt</span>
    </div>
    <Rep>
    ...
    <div style={{marginTop:'6px'}}>
      <Body><strong style={{color:'var(--text-primary)'}}>Why it works:</strong> "Last voicemail" removes pressure. "Hope business is going well" leaves warmth. They often call back because you stopped chasing.</Body>
    </div>
    ...
    <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'8px'}}>
      <span className="tag" style={{fontSize:'9px'}}>10-15 SEC</span>
      <span style={{fontSize:'11px',color:'var(--text-muted)',fontWeight:600}}>Returning their call</span>
    </div>
    <Rep>
    ...
    <div style={{marginTop:'6px'}}>
      <Body><strong style={{color:'var(--text-primary)'}}>Why it works:</strong> "I've got your info pulled up" signals you're prepared and professional. Two response paths (call or text) maximizes callback rate.</Body>
    </div>
