...
const FoundationPanel = () => {
  ...
  return (
    <div>
      ...
      <h2 style={{fontSize:'26px',fontWeight:900,color:'#fff',margin:'8px 0 4px'}}>Foundation & Blueprint</h2>
      <Body>The immovable core — who we are, who we serve, and how we win.</Body>

      {/* ── Tab Bar ── */}
      <div style={{display:'flex',flexWrap:'wrap',gap:'6px',margin:'16px 0',padding:'4px 0',borderBottom:'1px solid #1a1a1a'}}>
        {FOUNDATION_TABS.map(t=>(
          <button key={t.id} onClick={()=>setActiveTab(t.id)} style={{
            padding:'7px 14px',borderRadius:'6px 6px 0 0',cursor:'pointer',
            background:activeTab===t.id?'rgba(0,240,255,.08)':'transparent',
            border:activeTab===t.id?'1px solid rgba(0,240,255,.3)':'1px solid transparent',
            borderBottom:activeTab===t.id?'2px solid #00F0FF':'2px solid transparent',
            color:activeTab===t.id?'#00F0FF':'#555',
        ...
        <div>
          ...
          <div className="card" style={{padding:'18px 20px',marginBottom:'12px'}}>
            <ul style={{padding:0,margin:0}}>
              <Li><strong style={{color:'#fff'}}>Targeting:</strong> Canadian trades businesses — cleaning, landscaping, plumbing, construction, pressure washing, window washing, and more.</Li>
              <Li><strong style={{color:'#fff'}}>The Hook (The 0.5 Offer):</strong> A $1,500 CAD Custom Website — $500 deposit, $1,000 on delivery. Engineered to convert immediately.</Li>
              <Li><strong style={{color:'#fff'}}>The Edge:</strong> We don't just "get leads." We solve <strong style={{color:'#00F0FF'}}>Lead Decay</strong>. We provide the AI Nurture Loop that responds to customers in <strong style={{color:'#00F0FF'}}>under 30 seconds</strong>.</Li>
            </ul>
          </div>
        </div>
      )}
        ...
        <div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(200px, 1fr))',gap:'12px',marginBottom:'12px'}}>
            <div className="card-glow" style={{padding:'18px 20px'}}>
              <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.15em',textTransform:'uppercase',color:'#00F0FF',margin:'0 0 8px'}}>Commission</p>
              <p style={{fontSize:'22px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>$500 CAD</p>
              <p style={{color:'#666',fontSize:'13px',margin:0}}>Flat per 0.5 Close — Paid 100% upfront</p>
            </div>
            <div className="card-glow" style={{padding:'18px 20px'}}>
              <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.15em',textTransform:'uppercase',color:'#00F0FF',margin:'0 0 8px'}}>The Math</p>
              <p style={{fontSize:'22px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>$10,000/mo</p>
              <p style={{color:'#666',fontSize:'13px',margin:0}}>5 Closes per week</p>
            </div>
          </div>
        </div>
      )}
      ...
      {activeTab==='career' && (
        <div>
          ...
          <div className="card" style={{padding:'18px 20px',marginBottom:'12px'}}>
            <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.15em',textTransform:'uppercase',color:'#00F0FF',margin:'0 0 12px'}}>Career Ladder</p>
            <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
              {[
                ...
                <div key={i} style={{display:'flex',alignItems:'flex-start',gap:'12px',padding:'10px 12px',background:'rgba(255,255,255,.02)',border:'1px solid #1a1a1a',borderRadius:'8px'}}>
                  <span className="dot">{i+1}</span>
                  <div>
                    <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'14px'}}>{r.role}</p>
                    <p style={{margin:0,color:'#777',fontSize:'13px'}}>{r.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {activeTab==='icp' && (
        <div>
          ...
          <div className="card-glow" style={{padding:'20px 22px',marginBottom:'16px'}}>
            <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.15em',textTransform:'uppercase',color:'#00F0FF',margin:'0 0 10px'}}>Who We Target</p>
            <p style={{color:'#ccc',fontSize:'14px',lineHeight:1.6,margin:0}}>Canadian service-based businesses (public). <strong style={{color:'#fff'}}>All businesses</strong> (behind closed doors).</p>
          </div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(180px, 1fr))',gap:'10px',marginBottom:'16px'}}>
            <div className="card" style={{padding:'16px 18px',borderLeft:'3px solid #ff4444'}}>
              ...
              <p style={{color:'#aaa',fontSize:'13px',lineHeight:1.5,margin:0}}>Minimal online presence. NEED us most. <strong style={{color:'#fff'}}>Call first.</strong></p>
            </div>
            <div className="card" style={{padding:'16px 18px',borderLeft:'3px solid #ff9933'}}>
              ...
              <p style={{color:'#aaa',fontSize:'13px',lineHeight:1.5,margin:0}}>Established but not dominant. Strong pitch opportunity.</p>
            </div>
            <div className="card" style={{padding:'16px 18px',borderLeft:'3px solid #ffcc00'}}>
              ...
              <p style={{color:'#aaa',fontSize:'13px',lineHeight:1.5,margin:0}}>More established, harder sell, bigger deals.</p>
            </div>
            <div className="card" style={{padding:'16px 18px',borderLeft:'3px solid #666',opacity:0.6}}>
              <p style={{fontSize:'10px',fontWeight:800,letterSpacing:'.15em',textTransform:'uppercase',color:'#666',margin:'0 0 6px',fontFamily:"'JetBrains Mono',monospace"}}>DISQUALIFIED (100+)</p>
              <p style={{color:'#777',fontSize:'13px',lineHeight:1.5,margin:0}}>Skip. Too big, already have systems.</p>
            </div>
          </div>
          ...
          <div className="card" style={{padding:'18px 20px'}}>
            ...
            <div style={{marginTop:'12px',padding:'10px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'8px'}}>
              <p style={{color:'#888',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>Signal:</strong> 100 or fewer reviews + no signs of large commercial work.</p>
            </div>
          </div>
        </div>
      )}
      ...
      {activeTab==='daily' && (
        <div>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'10px',marginBottom:'20px'}}>
            {[
              {time:'8:00 AM',label:'PREP',dur:'15 min',color:'#00F0FF',items:['Open portal, check callbacks due','Review yesterday\'s notes on warm leads','Set daily target: 50 calls minimum']},
              ...
              {time:'10:15 AM',label:'BREAK',dur:'15 min',color:'#555',items:[]},
              ...
              {time:'12:00 PM',label:'LUNCH',dur:'30 min',color:'#555',items:[]},
              ...
              {time:'3:30 PM',label:'DONE',dur:'',color:'#00F0FF',items:['Or keep going if you\'re on fire']},
            ].map((block,i)=>(
              <div key={i} className="card" style={{padding:'14px 18px',borderLeft:`3px solid ${block.color}`}}>
                <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:block.items.length?'8px':'0'}}>
                  <span style={{fontSize:'13px',fontWeight:800,color:'#fff',fontFamily:"'JetBrains Mono',monospace",minWidth:'80px'}}>{block.time}</span>
                  ...
                  {block.dur && <span style={{fontSize:'10px',color:'#555',background:'#111',padding:'2px 8px',borderRadius:'4px',fontWeight:600}}>{block.dur}</span>}
                </div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(160px, 1fr))',gap:'10px',marginBottom:'16px'}}>
            <div className="card-glow" style={{padding:'16px 18px',textAlign:'center'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>50+</p>
              <p style={{fontSize:'11px',fontWeight:700,letterSpacing:'.1em',textTransform:'uppercase',color:'#00F0FF',margin:0,fontFamily:"'JetBrains Mono',monospace"}}>Dials</p>
            </div>
            <div className="card-glow" style={{padding:'16px 18px',textAlign:'center'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>8-10</p>
              <p style={{fontSize:'11px',fontWeight:700,letterSpacing:'.1em',textTransform:'uppercase',color:'#00F0FF',margin:0,fontFamily:"'JetBrains Mono',monospace"}}>Connects</p>
            </div>
            <div className="card-glow" style={{padding:'16px 18px',textAlign:'center'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>1-2</p>
              <p style={{fontSize:'11px',fontWeight:700,letterSpacing:'.1em',textTransform:'uppercase',color:'#00F0FF',margin:0,fontFamily:"'JetBrains Mono',monospace"}}>Callbacks / Bookings</p>
            </div>
            <div className="card-glow" style={{padding:'16px 18px',textAlign:'center'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>100%</p>
              <p style={{fontSize:'11px',fontWeight:700,letterSpacing:'.1em',textTransform:'uppercase',color:'#00F0FF',margin:0,fontFamily:"'JetBrains Mono',monospace"}}>Calls Logged</p>
            </div>
          </div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit, minmax(160px, 1fr))',gap:'10px'}}>
            <div className="card" style={{padding:'16px 18px',textAlign:'center',borderLeft:'3px solid #4ade80'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>250+</p>
            ...
            <div className="card" style={{padding:'16px 18px',textAlign:'center',borderLeft:'3px solid #4ade80'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>5+</p>
            ...
            <div className="card" style={{padding:'16px 18px',textAlign:'center',borderLeft:'3px solid #4ade80'}}>
              <p style={{fontSize:'28px',fontWeight:900,color:'#fff',margin:'0 0 4px'}}>1+</p>
        ...
        <div>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'12px'}}>
              ...
              <div>
                <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Google Reviews</p>
                <p style={{margin:0,color:'#555',fontSize:'12px'}}>How many? What rating? Read the latest 2-3.</p>
              </div>
            </div>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'12px'}}>
              ...
              <div>
                <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Website</p>
                <p style={{margin:0,color:'#555',fontSize:'12px'}}>Do they have one? How does it look?</p>
              </div>
            </div>
            <div style={{display:'flex',flexDirection:'column',gap:'6px'}}>
              <div style={{padding:'8px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'6px'}}>
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>No website</strong> = 0.5 offer (our $1,500 CAD website)</p>
              </div>
              <div style={{padding:'8px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'6px'}}>
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>Bad website</strong> = <em>"I actually went ahead and built a preview for you"</em></p>
              </div>
              <div style={{padding:'8px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'6px'}}>
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>Good website</strong> = Focus on lead gen, not the site itself</p>
              </div>
            </div>
          </div>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'12px'}}>
              ...
              <div>
                <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Google Maps Listing</p>
                <p style={{margin:0,color:'#555',fontSize:'12px'}}>Is it claimed? Photos? Business hours?</p>
              </div>
            </div>
            <div style={{padding:'8px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'6px'}}>
              <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>Unclaimed or sparse</strong> = Easy sell. They're leaving money on the table.</p>
            </div>
          </div>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'12px'}}>
              ...
              <div>
                <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Social Media</p>
                <p style={{margin:0,color:'#555',fontSize:'12px'}}>Instagram? Facebook? How active?</p>
              </div>
            </div>
            <div style={{display:'flex',flexDirection:'column',gap:'6px'}}>
              <div style={{padding:'8px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'6px'}}>
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>No socials</strong> = <em>"You're invisible to anyone under 40"</em></p>
              </div>
              <div style={{padding:'8px 14px',background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'6px'}}>
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}><strong style={{color:'#00F0FF'}}>Some activity</strong> = <em>"You're doing the work, but nobody's seeing it"</em></p>
              </div>
            </div>
          </div>
          ...
          <div className="card-glow" style={{padding:'20px 22px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'14px'}}>
              ...
              <div>
                <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Pick Your Opener</p>
                <p style={{margin:0,color:'#00F0FF',fontSize:'12px',fontWeight:600}}>Match the opener to what you found</p>
              </div>
            </div>
            <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
              <div style={{display:'flex',alignItems:'flex-start',gap:'10px',padding:'10px 14px',background:'rgba(255,255,255,.02)',border:'1px solid #1a1a1a',borderRadius:'8px'}}>
                ...
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}>Opener 3 (0.5 Base) or Opener 4 (Pre-Built Preview)</p>
              </div>
              <div style={{display:'flex',alignItems:'flex-start',gap:'10px',padding:'10px 14px',background:'rgba(255,255,255,.02)',border:'1px solid #1a1a1a',borderRadius:'8px'}}>
                ...
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}>Opener 1 (Gap/Improvement)</p>
              </div>
              <div style={{display:'flex',alignItems:'flex-start',gap:'10px',padding:'10px 14px',background:'rgba(255,255,255,.02)',border:'1px solid #1a1a1a',borderRadius:'8px'}}>
                ...
                <p style={{color:'#aaa',fontSize:'13px',margin:0,lineHeight:1.5}}>Opener 2 (Meta/GSA)</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'10px',marginBottom:'12px'}}>
              ...
              <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Website — $1,500 CAD</p>
            </div>
            <ul style={{padding:0,margin:0}}>
              <Li>Custom-coded in React (same technology as Netflix, Airbnb)</Li>
              <Li><strong style={{color:'#fff'}}>NOT</strong> a WordPress template — hand-built, unique to each client</Li>
              <Li>Mobile responsive, fast loading, SEO optimized</Li>
              <Li>Hosted on Vercel — 99.99% uptime, blazing fast</Li>
              <Li><strong style={{color:'#00F0FF'}}>Client owns it forever.</strong> No hostage model.</Li>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'10px',marginBottom:'12px'}}>
              ...
              <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>Lead Generation</p>
            </div>
            <ul style={{padding:0,margin:0}}>
              <Li><strong style={{color:'#fff'}}>Google Ads</strong> — search campaigns targeting people actively looking</Li>
              <Li><strong style={{color:'#fff'}}>Meta Ads</strong> — Facebook + Instagram targeting local homeowners</Li>
              <Li><strong style={{color:'#fff'}}>SEO</strong> — Google Business Profile optimization, local search ranking</Li>
          ...
          <div className="card" style={{padding:'20px 22px',marginBottom:'12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'10px',marginBottom:'12px'}}>
              ...
              <p style={{margin:0,fontWeight:700,color:'#fff',fontSize:'15px'}}>AI Layer</p>
            </div>
            <ul style={{padding:0,margin:0}}>
              <Li><strong style={{color:'#fff'}}>AI Voice Receptionist (Vapi)</strong> — answers calls 24/7, books appointments</Li>
              <Li><strong style={{color:'#fff'}}>Automated SMS</strong> — texts leads back in under 30 seconds</Li>
              <Li><strong style={{color:'#fff'}}>AI Website Chatbot</strong> — converts visitors after hours</Li>
              <Li><strong style={{color:'#fff'}}>CRM Automation</strong> — pipeline runs itself, follow-ups fire automatically</Li>
              <Li><strong style={{color:'#fff'}}>Automated Email Sequences</strong> — nurture leads on autopilot</Li>
            </ul>
          </div>

          <div className="card-glow" style={{padding:'20px 22px',marginBottom:'16px'}}>
            <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.15em',textTransform:'uppercase',color:'#00F0FF',margin:'0 0 10px',fontFamily:"'JetBrains Mono',monospace"}}>The Speed Advantage</p>
            <p style={{color:'#ccc',fontSize:'15px',lineHeight:1.7,margin:0,fontStyle:'italic'}}>"When a lead comes in, our AI responds in <strong style={{color:'#00F0FF'}}>under 30 seconds</strong>. Your competitor takes <strong style={{color:'#ff8080'}}>42 hours on average</strong>. By the time they check their voicemail, the job is already booked."</p>
          </div>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
            {[
              ...
              <div key={i} style={{display:'flex',alignItems:'flex-start',gap:'12px',padding:'12px 14px',background:'rgba(255,255,255,.02)',border:'1px solid #1a1a1a',borderRadius:'8px'}}>
                <span className="dot">{d.num}</span>
                <p style={{margin:0,color:'#ccc',fontSize:'14px',lineHeight:1.5}}>{d.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {activeTab==='compete' && (
        <div>
          ...
          <div className="card-glow" style={{padding:'20px 22px'}}>
            <p style={{fontSize:'10px',fontWeight:700,letterSpacing:'.15em',textTransform:'uppercase',color:'#00F0FF',margin:'0 0 10px',fontFamily:"'JetBrains Mono',monospace"}}>The Line That Wins</p>
            <p style={{color:'#ccc',fontSize:'16px',lineHeight:1.7,margin:0,fontStyle:'italic',fontWeight:600}}>"Keep your current agency for marketing. Add us for the AI layer they can't do."</p>
          </div>
        </div>
      )}
    </div>
