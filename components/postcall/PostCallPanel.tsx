...
const PostCallPanel = () => (
  <div>
    ...
    <Body>If the prospect is on a job site or driving, <strong style={{color:'#fff'}}>do not let them say "Just send me an email."</strong> Pivot to SMS with a 30-second screen record.</Body>
    ...
    <Body>Once you get the verbal "Yes," execute these three steps <strong style={{color:'#fff'}}>flawlessly.</strong></Body>
    <div style={{display:'flex',flexDirection:'column',gap:'12px',marginTop:'14px'}}>
      <div className="card-glow" style={{padding:'20px'}}>
        <div style={{display:'flex',gap:'14px',alignItems:'flex-start'}}>
          <span className="dot" style={{flexShrink:0}}>1</span>
          <div style={{flex:1}}>
            <p style={{margin:'0 0 10px',fontWeight:700,color:'#fff',fontSize:'15px'}}>The Google Meet Lock-In</p>
      ...
      <div className="card-glow" style={{padding:'20px'}}>
        <div style={{display:'flex',gap:'14px',alignItems:'flex-start'}}>
          ...
          <div style={{flex:1}}>
            <p style={{margin:'0 0 10px',fontWeight:700,color:'#fff',fontSize:'15px'}}>Asset Collection — The 5-Day Clock</p>
      ...
      <div className="card" style={{padding:'20px'}}>
        <div style={{display:'flex',gap:'14px',alignItems:'flex-start'}}>
          ...
          <div style={{flex:1}}>
            <p style={{margin:'0 0 10px',fontWeight:700,color:'#fff',fontSize:'15px'}}>Internal Comm — The Ping</p>
            <p style={{color:'#888',fontSize:'13px',margin:'0 0 10px'}}>Ping Elliott in the internal chat with the following format:</p>
            <div style={{background:'rgba(0,240,255,.04)',border:'1px solid rgba(0,240,255,.15)',borderRadius:'8px',padding:'14px 16px',fontFamily:'monospace'}}>
              <p style={{color:'#00F0FF',fontSize:'13px',margin:'0 0 6px',fontWeight:600}}>// Internal Ping Template</p>
              <p style={{color:'#ccc',fontSize:'13px',margin:'2px 0'}}>Lead Name / Company: <span style={{color:'#555'}}>___________</span></p>
              <p style={{color:'#ccc',fontSize:'13px',margin:'2px 0'}}>Niche: <span style={{color:'#555'}}>___________</span></p>
              <p style={{color:'#ccc',fontSize:'13px',margin:'2px 0'}}>Pain Point Uncovered: <span style={{color:'#555'}}>e.g., "Hates current Meta Ads, leads are low quality"</span></p>
              <p style={{color:'#ccc',fontSize:'13px',margin:'2px 0'}}>Next Step: <span style={{color:'#555'}}>e.g., "Meet booked for 2 PM Tuesday / Invoice ready to send"</span></p>
            </div>
          </div>
        </div>
      </div>
