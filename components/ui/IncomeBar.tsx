  ...
  return (
    <div style={{marginBottom:'12px'}}>
      <div style={{display:'flex', justifyContent:'space-between', fontSize:'12px', marginBottom:'5px', gap:'8px', flexWrap:'wrap'}}>
        <span style={{color:'var(--text-tertiary)', minWidth:0}}>{label}</span>
        <span style={{fontFamily:'monospace', fontWeight:700, color:'var(--text-primary)', flexShrink:0}}>{fmtCAD(amount)}</span>
      </div>
