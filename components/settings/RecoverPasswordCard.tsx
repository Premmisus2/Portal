...
export default function RecoverPasswordCard({ userEmail }: Props) {
  ...
  return (
    ...
    >
      {sent ? (
        <p style={{ margin: 0, fontSize: '12px', color: '#22c55e', fontFamily: 'Roboto, sans-serif' }}>
          Reset email sent to <span style={{ fontFamily: 'JetBrains Mono, monospace', color: '#9be7b1' }}>{userEmail}</span>. Check your inbox (and spam folder).
        </p>
      ) : (
